...
::: callout-note
The `round()` function in R is used to make numbers easier to read by shortening them to a set number of decimal places. It takes a number and rounds it to the number of decimal places you choose. 
:::
