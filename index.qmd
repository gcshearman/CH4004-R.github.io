...
+=============+=================================================================+===============================================================================+
| 1           | R You Ready? Getting                                            | Introduction to R                                                             |
|             | Started with Chemistry                                          | Basic syntax                                                                  |
|             | Data!                                                           | Simple plotting                                                               |
+-------------+-----------------------------------------------------------------+-------------------------------------------------------------------------------+
| 2           | Data in a Lab Coat: Cleaning                                    | Importing data using `readr`\                                                 |
|             | and Wrangling Your Chemistry Data                               | Data cleaning and manipulation using `dplyr`                                  |
+-------------+-----------------------------------------------------------------+-------------------------------------------------------------------------------+
| 3           | Plotting Power! Visualizing Your Data Like a Pro                | Complex visualizations for scientific data                                    |
...
+-------------+-----------------------------------------------------------------+-------------------------------------------------------------------------------+
| 5           | Tox Talk: Exploring Toxicity Data with Statistics               | Introduction to using R for statistical tests for                             |
|             |                                                                 | comparing groups (e.g., t-tests, ANOVA)                                       |
+-------------+-----------------------------------------------------------------+-------------------------------------------------------------------------------+
| 6           | Statistics Are Sexy: Hypothesis Testing and p                   | Introduction to the use of R for hypothesis testing and interpreting p-values |
|             | values                                                          |                                                                               |
+-------------+-----------------------------------------------------------------+-------------------------------------------------------------------------------+
...
+-------------+-----------------------------------------------------------------+-------------------------------------------------------------------------------+
| 10          | Statistical Sherlock: Investigating Toxicity with Statistics    | Conducting statistical hypothesis testing to                                  |
